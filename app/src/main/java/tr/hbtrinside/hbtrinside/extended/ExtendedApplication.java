...
import tr.hbtrinside.hbtrinside.model.ParameterObjects.ResponseHelper;
import tr.hbtrinside.hbtrinside.core.RunAsyncTask;
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    BufferedWriter wrt = new BufferedWriter(new OutputStreamWriter(wr,"UTF-8"));
                    //wr.writeBytes(Url[1]);
                    //wr.flush();
                    //wr.close();
                    wrt.write(Url[1]);
